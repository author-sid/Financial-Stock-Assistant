...
functions = [
    ...
    {
        'name': 'calculate_MACD',
        'description': 'calculate the MACD fror a given stock ticker ',
        'parameters': {
            'type': 'object',
            'properties': {
                'ticker': {
    ...
    },
    {
        ...
        'description': 'plot the stock prize for the last year given the ticker symbol of a company',
        'parameters': {
            'type': 'object',
            'properties': {
                'ticker': {
...
if user_input:
    try:
        ...
        if response_message.get('function_call'):
            ...
            elif function_name in ['calcluate_SMA','calculate_EMA']:
